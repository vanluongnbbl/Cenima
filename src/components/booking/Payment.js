...
const Payment = (props) => {
  ...
  const handleEditSeat = () => {
    if (saveBooking !== null && getSeatStatus !== null && saveSeats !== null) {
      ...
      if (
        saveBooking.sessionId === getSeatStatus[0].id &&
        saveSeats.seats === getSeatStatus.numberSeat.codeSeat
      ) {
        setEditSeat(true);
      }
    }
        ...
        <form className="payment" onSubmit={handleSubmit}>
          <div className="container">
            ...
            <div className="payment__main">
              <div className="payment__main__title">
                {t("home.totalPayment")}
              </div>
              <div className="payment__main__content">
                <div className="wrapper">
                  <div className="pay">
                    <span className="pay__content key">
                      {t("home.paymentMovie")}
                    </span>
                    <span className="pay__content value">
                      {totalMoviePrice()
                        .toString()
                        .replace(/\B(?=(\d{3})+(?!\d))/g, ".")}{" "}
                      VND
                  ...
                  <div className="pay">
                    <div className="pay__content key">
                      {t("home.paymentFood")}
                    </div>
                    <div className="pay__content value">
                      {saveFoods.totalFood
                        .toString()
                        .replace(/\B(?=(\d{3})+(?!\d))/g, ".")}{" "}
                      VND
            ...
            <div className="payment__total">
              ...
              <span className="total">
                <button type="submit" className="total__item">
                  {t("home.payment")}
                </button>
              </span>
            </div>
